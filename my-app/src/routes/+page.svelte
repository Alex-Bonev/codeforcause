  ...
  <div class="h-screen flex flex-col col-span-3">
    ...
    <div class="flex-1 w-full">
      ...
      <div class="w-full mx-auto grid place-items-center relative">
        ...
        <button on:click={()=>{goto('/home'); console.log("yay")}} class="animate-button h-16 border-4 w-48 bg-white border-secondary text-secondary rounded-full  hover:scale-110 transition-all duration-500 ease-in-out">Jump In</button>
      </div>
    </div>
  </div>
